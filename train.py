...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=5*1e-5, help='the initial learning rate')
    ...
    parser.add_argument('--max-epoch', type=int, default=500, help='max training epoch')
